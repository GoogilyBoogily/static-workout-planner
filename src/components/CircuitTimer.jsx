 ...
 * @param {Object} props
 * @param {Function} props.onClose - Callback to close timer and return to plan list
 * @param {Object} props.plan - The workout plan to use with the timer
 * @param {Function} props.onUpdatePlan - Callback to update plan when exercises are reordered
 */
function CircuitTimer({ onClose, plan, onUpdatePlan }) {
    ...
    intervalRef.current = setInterval(() => {
      setRemainingSeconds(prev => {
        ...
        if (prev <= 5 && prev > 0 && !isPaused) {
          ...
          let soundKey = config.sounds[phase]
  ...
  const handleSoundChange = (phase, soundKey) => {
    setConfig(prev => ({
      ...prev,
      sounds: {
        ...prev.sounds,
  ...
  const handleTestSound = (phase) => {
    initAudio()
    playSound(config.sounds[phase], config.volume)
  }
  ...
  const handleDrop = (e, dropIndex) => {
    e.preventDefault()
    if (phase !== 'idle' || draggedIndex === null || draggedIndex === dropIndex || !onUpdatePlan) {
      setDragOverIndex(null)
      return
    }
    ...
    const targetRoundGroup = exercises[dropIndex].roundGroup ?? 0
        ...
        <div className="timer-config">
          <div className="config-field">
            ...
            <input
              ...
              onChange={(e) => handleConfigChange('exerciseDuration', e.target.value)}
            />
          </div>
          ...
          <div className="config-field">
            ...
            <input
              ...
              onChange={(e) => handleConfigChange('restDuration', e.target.value)}
            />
          </div>
          ...
          <div className="config-field">
            ...
            <input
              ...
              onChange={(e) => handleConfigChange('finisherDuration', e.target.value)}
            />
          </div>
          ...
          <div className="config-field">
            ...
            <input
              ...
              onChange={(e) => handleConfigChange('warningTime', e.target.value)}
            />
          </div>
          ...
          <div className="sound-settings">
            ...
            <div className="sound-selector-row">
              ...
              <select
                ...
                onChange={(e) => handleSoundChange('exercise', e.target.value)}
            ...
            <div className="sound-selector-row">
              ...
              <select
                ...
                onChange={(e) => handleSoundChange('rest', e.target.value)}
                className="sound-select"
              >
                {Object.entries(SOUND_PRESETS).map(([key, preset]) => (
                  <option key={key} value={key}>{preset.name}</option>
            ...
            <div className="sound-selector-row">
              ...
              <select
                ...
                onChange={(e) => handleSoundChange('finisher', e.target.value)}
                className="sound-select"
              >
                {Object.entries(SOUND_PRESETS).map(([key, preset]) => (
                  <option key={key} value={key}>{preset.name}</option>
            ...
            <div className="sound-selector-row">
              ...
              <select
                ...
                onChange={(e) => handleSoundChange('warning', e.target.value)}
                className="sound-select"
              >
                {Object.entries(SOUND_PRESETS).map(([key, preset]) => (
                  <option key={key} value={key}>{preset.name}</option>
            ...
            <div className="sound-selector-row">
              ...
              <select
                ...
                onChange={(e) => handleSoundChange('complete', e.target.value)}
                className="sound-select"
              >
                {Object.entries(SOUND_PRESETS).map(([key, preset]) => (
                  <option key={key} value={key}>{preset.name}</option>
