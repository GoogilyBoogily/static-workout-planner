...
import type { ParsedExercise, PlanExercise, ValidationErrors } from '../types'
 ...
 */
function ExerciseForm({ exercise, exerciseLibrary = [], onSave, onCancel }: ExerciseFormProps) {
  ...
  const handleSelectExercise = (libraryExercise: ParsedExercise) => {
    setFormData(prev => ({
      ...prev,
    ...
    switch (e.key) {
      ...
      case 'Enter':
        ...
        if (highlightedIndex >= 0 && highlightedIndex < filteredExercises.length) {
          const selected = filteredExercises[highlightedIndex]
          if (selected) {
  ...
  const handleSubmit = () => {
    ...
    const exerciseData: PlanExercise = {
    ...
    if (exerciseData.weight === undefined) delete exerciseData.weight
    if (exerciseData.rest === undefined) delete exerciseData.rest
      ...
      <div className="form-row">
        <div className="form-field">
          ...
          <input
            ...
            max="20"
            value={formData.sets}
            onChange={(e: ChangeEvent<HTMLInputElement>) => handleChange('sets', e.target.value)}
            placeholder="e.g., 4"
        ...
        <div className="form-field">
          ...
          <input
            ...
            type="text"
            value={formData.reps}
            onChange={(e: ChangeEvent<HTMLInputElement>) => handleChange('reps', e.target.value)}
      ...
      <div className="form-row">
        ...
        <div className="form-field">
          ...
          <input
            ...
            type="text"
            value={formData.rest}
            onChange={(e: ChangeEvent<HTMLInputElement>) => handleChange('rest', e.target.value)}
